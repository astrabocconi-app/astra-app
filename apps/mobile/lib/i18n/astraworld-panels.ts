// Panel details for ASTRAWORLD, condensed from the four run-sheets into
// something that sells the session in a few seconds. Kept separate from
...
export const en = {
  ...
  "awp.chapeau.hook":
    "From an idea to a project that opens doors. How you get interesting people to say yes when nobody knows who you are yet, and how content stops being content and turns into a network, credibility and real opportunities.",
  "awp.chapeau.s1": "Pietro Santini",
...
export const it: Record<keyof typeof en, string> = {
  ...
  "awp.chapeau.org": "Chapeau Project",
  "awp.chapeau.short": "Costruire qualcosa che nessuno può ignorare",
  "awp.chapeau.title": "Costruire qualcosa che nessuno può ignorare",
  "awp.chapeau.hook":
    "Da un'idea a un progetto che apre porte. Come si convince gente interessante a dire di sì quando ancora nessuno sa chi sei, e come il contenuto smette di essere contenuto e diventa rete, credibilità e opportunità reali.",
  "awp.chapeau.s1": "Pietro Santini",
  "awp.chapeau.s2": "Giacomo Luppi",
  "awp.chapeau.s3": "Filippo Carabelli",

  "awp.spoons.org": "Bending Spoons",
  "awp.spoons.short": "Assumere in scala",
